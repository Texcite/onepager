        ...
        >
            <Container className="mt-16">
                ...
                <div className='overflow-hidden rounded-lg  flex items-center justify-center'>
                    <Image src={storyboard} alt="" unoptimized height="400" width="auto"/>
                </div>
                <p className="mt-4 concept-short-description">
                    AI Video Interactive
                    Storyboard (AVIS) is een tool die je kan helpen om jouw scene in een interactieve manier visual te
                    maken. Met behulp van AI wordt jouw scene, aan de hand van een omschrijving van je idee, omgezet tot
                    een video. Dit zorgt voor een visueel beeld van je storyboard meet een interactieve twist.
                </p>
            </Container>
            <Container size="lg" className="mt-16 py-32 flex flex-row items-center justify-between">
                <div>
            ...
            <Container className="mt-16">
                <h3 className="font-display concept-subtitle">
                ...
                <div className="mt-8  grid grid-cols-2 gap-8 justify-items-center">
                    <div className="col-span-1 bg-red-800 overflow-hidden">
                        <Image src={storyboard1} alt="" unoptimized />
                    </div>
                    <div className="col-span-1 ">
                        <Image src={storyboard2} alt="" unoptimized />
                    </div>
                    <div className="col-span-1">
                        <p className="mt-8 concept-body-text">
                            A women walking outside into a beautiful sunset, in the style of 3D, octane render, 8k,
                            ray-tracing, blender, hyper-detailed"
                        </p>
                    </div>
                    <div className="col-span-1">
                        <p className="mt-8 concept-body-text">
                            A women walking on the sidewalk, car passing by her, focus to the car, in the style of 3D,
                            octane render, 8k, ray-tracing, blender, hyper-detailed.
                        </p>
                    </div>
                </div>
            </Container>
            <Container className="mt-16 py-32">
                ...
                <p className="mt-8 concept-body-text">
                    Avis wordt ontwikkeld als een web-applicatie die gebruik maakt van AI die getraind is in het
                    genereren van video's. Hierbij gaan we react gebruiken om de website te bouwen vanwege de snelheid
                    en flexibiliteit.
                </p>
                <ul role="list" className="mt-8 space-y-3">
                    {[
